...
Se proyectan tres escenarios de efectividad basados en el volumen de clientes rescatados por trimestre:
...
Los resultados indican que, en un escenario de efectividad media (Neutro), el modelo permite retener un valor patrimonial de \$154 millones. Dado el volumen de facturación de la compañía, la preservación de este capital mediante la gestión del churn representa una optimización financiera significativa sobre los activos de la empresa.
...
Las métricas obtenidas muestran que el modelo discrimina con solidez entre clientes que se darán de baja y clientes que permanecerán activos, y que el 20\,\% de la cartera con mayor probabilidad estimada concentra cerca del 70\,\% de las bajas. Esta capacidad de focalización se vincula directamente con la evaluación económica realizada bajo el enfoque de \textit{Customer Lifetime Value} (CLV), la cual evidenció que la fuga de clientes implica una destrucción de valor patrimonial significativa. Los análisis indican que, en un escenario de efectividad operativa media, la gestión focalizada permite preservar activos por un valor cercano a los \$154 millones anuales, demostrando que la retención es una palanca de rentabilidad crítica y suficiente para justificar el esfuerzo de implementación y mantenimiento del sistema.

El prototipo operativo integra el modelo en el flujo real de trabajo mediante tres piezas principales: el script SQL que genera el datamart, el cuaderno de scoring en Google Colab y el archivo de Excel que presenta los resultados en un formato familiar para el usuario final. Sobre esta base, el equipo de Customer Success dispone de un repositorio de datos estructurado, de un modelo analítico validado, de segmentos de clientes definidos según riesgo, valor, rubro y plan, y de un procedimiento documentado para aplicar el modelo de forma periódica. La información de motivos de baja por rubro y plan se incorpora como insumo adicional para interpretar los segmentos y ajustar las acciones sugeridas en cada contexto, lo que refuerza el vínculo entre la salida del modelo y la experiencia del equipo que trabaja directamente con los clientes.

En conjunto, estos elementos permiten avanzar en el objetivo general de desarrollar un modelo de segmentación conductual que habilite políticas de fidelización diferenciadas. El proyecto deja trazada una ruta para el trabajo posterior de la empresa: incorporar nuevas fuentes de información, como registros sistemáticos de visitas a los centros y métricas de satisfacción; profundizar en el análisis comparativo con la competencia; automatizar gradualmente el despliegue en la infraestructura propia; y diseñar pilotos que midan de manera conjunta la efectividad y el costo de las acciones de retención basadas en los scores del modelo. De este modo, Reservo queda en posición de transformar la analítica de churn en un componente estable de su estrategia, utilizando el comportamiento de sus clientes y los motivos de baja observados como eje para decidir cómo, cuándo y con qué intensidad intervenir, conectando de forma explícita las decisiones de Customer Success con el impacto económico real en el valor de la compañía.
