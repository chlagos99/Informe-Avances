...
La quinta tarea cuantificó una línea base económica de la cartera. Se fijó \(N_{\mathrm{activos}} \approx 3{.}500\) y un ingreso anual recurrente cercano a \(2{.}465{.}400{.}000\), lo que da \(\mathrm{MRR}_{\mathrm{base}} \approx 205{.}450{.}000\) y un ingreso promedio por cuenta \(\mathrm{ARPA} \approx 58{.}700\). Con una tasa de bajas mensuales \(\mathrm{Churn}_{\mathrm{base}} = 0{,}024\) se estimó que se pierden cerca de \(N_{\mathrm{bajas}} \approx 84\) clientes al mes y un ingreso \(\mathrm{MRR}_{\mathrm{perdido}} \approx 4{.}930{.}800\), equivalente a unos \(59{.}200{.}000\) al año. 
