...
\insertimage[\label{img:etapa_adquisicion}]{bizagi/captacion.png}{scale=0.25}{Etapa de Adquisición en Reservo}
...
\insertimage[\label{img:etapa_venta}]{bizagi/cliente_activo.png}{scale=0.15}{Etapa de Venta en Reservo}
...
\insertimage[\label{img:etapa_onboarding}]{bizagi/onboarding.png}{scale=0.15}{Etapa de Onboarding del cliente en Reservo}
...
En la figura \ref{img:etapa_cliente_activo} se presenta la \textbf{Etapa de Cliente Inactivo}
...
\begin{appendixd}
	...
	% la configuración \appendixindepobjnum
	  \insertimage[\label{img:proceso_completo}]{bizagi/proceso_completo.png}{scale=0.1}{Proceso completo de cliente en Reservo}
