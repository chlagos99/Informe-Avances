...
\ifthenelse{\equal{\stylecitereferences}{natbib}}{% Formato citas natbib
    ...
    \ifthenelse{\equal{\natbibrefcitecompress}{true}}{
        % Opciones añadidas aquí
        \usepackage[round, authoryear, longnamesfirst, sort&compress]{natbib}
    }{
        % Opciones añadidas también aquí
...
\newenvironment{appendixd}{%
    ...
    \sectionanum{\nameappendixsection} % <--- LÍNEA AGREGADA AQUÍ
...
\newcommand{\templatePortrait}{%
	...
	\ifthenelse{\equal{\portraitstyle}{style1}}{%
		...
		\begin{center}
			\textcolor{\portraittitlecolor}{%
				{\noindent \large{\documenttitle} \vspace{0.9cm}} ~ \\
	...
	\ifthenelse{\equal{\portraitstyle}{style5}}{%
		...
		% Escribe el header
		\coreinsertkeyimage{\portraitimageparamsF}{\portraitimageF}
		\hspace{-0.05cm}
		\begin{tabular}{l}
			% Inserta nuevas lineas independiente de si tiene texto o no
			\COREwriteheaderitemsc[~ \\]{\universityname}
		...
		\vspace{2.5cm}
		\begin{center}
			\fontsize{4.2mm}{6.2mm}\selectfont
			\textcolor{\portraittitlecolor}{%
	...
	\ifthenelse{\equal{\portraitstyle}{style7}}{%
		...
		\begin{center}
			...
			{\large \textcolor{\portraittitlecolor}{\documenttitle} \vspace{0.2cm} ~ \\}
		...
		\begingroup
			...
			\begin{tikzpicture}[remember picture,overlay]
				...
				\draw (current page.center) node [fill=\portraitbackgroundcolorB!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{%
						\centering \textcolor{\portraittitlecolor}{\documenttitle} \\ [8pt]
...
\newcommand{\templatePagecfg}{%
	...
	% --- Estilo de títulos (tamaños exactos) ---
	\sectionfont{%
	\color{\sectioncolor}\sectionfontstyle\fontsize{10.5pt}{12.3pt}\selectfont%
	}
	\subsectionfont{%
	\color{\ssectioncolor}\ssectionfontstyle\fontsize{13.5pt}{16.6pt}\selectfont%
	}
	\subsubsectionfont{%
	\color{\sssectioncolor}\sssectionfontstyle\fontsize{12pt}{14.2pt}\selectfont%
	}
	\titleformat{\subsubsubsection}{%
	\color{\ssssectioncolor}\ssssectionfontstyle\fontsize{10pt}{12pt}\selectfont%
	}{%
