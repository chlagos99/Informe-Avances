...
\newcommand{\templatePagecfg}{%
	...
	\sectionfont{%
	\color{\sectioncolor}\sectionfontstyle\fontsize{11.5pt}{13.8pt}\selectfont%
	}
	\subsectionfont{%
	\color{\ssectioncolor}\ssectionfontstyle\fontsize{13pt}{15.6pt}\selectfont%
	}
	\subsubsectionfont{%
	\color{\sssectioncolor}\sssectionfontstyle\fontsize{10.5pt}{12.6pt}\selectfont%
	}
