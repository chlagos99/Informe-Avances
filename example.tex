...
% ------------------------------------------------------------------------------
\clearpage
\section{La industria/sector}

\clearpage
\section{Empresa/organización en la cual está inserto}
...
\begin{table}[H]
  \begin{threeparttable}
    ...
    \begin{tabular}{|l|C{3.5cm}|C{4cm}|C{5.5cm}|}
      \hline
      \textbf{Estado} & \textbf{Definición} & \textbf{Métricas asociadas} & \textbf{Fórmula / Cálculo} \\
      \hline
      Desconocido & Persona que aún no conoce Reservo. & Alcance de campañas, impresiones, visitas web. &
      Impresiones: nº total de veces que se muestra la campaña. \newline
      Visitas web: nº de sesiones registradas en la web. \\
      \hline
      Lead & Persona que mostró interés y dejó sus datos. &
      Nº de leads, CPL, Tasa de conversión visitante→lead. &
      CPL = $\tfrac{\text{Gasto en marketing}}{\text{Nº leads generados}}$ \newline
      Conversión = $\tfrac{\text{Nº leads}}{\text{Nº visitas web}} \times 100$ \\
      \hline
      Lead calificado & Lead validado por SDR como encajado con el software. &
      Tasa de leads calificados, \% descartados. &
      SQL rate = $\tfrac{\text{Nº leads calificados}}{\text{Nº leads totales}} \times 100$ \newline
      Descartados = $\tfrac{\text{Nº leads descartados}}{\text{Nº leads}} \times 100$ \\
      \hline
      Oportunidad de venta & Cliente potencial en demo o propuesta. &
      Conversión a oportunidad, Win rate. &
      Conversión = $\tfrac{\text{Nº oportunidades}}{\text{Nº leads calificados}} \times 100$ \newline
      Win rate = $\tfrac{\text{Nº ventas cerradas}}{\text{Nº oportunidades}} \times 100$ \\
      \hline
      Cliente nuevo & Contrató el servicio y fue dado de alta. &
      Nº de clientes nuevos, CAC. &
      CAC = $\tfrac{\text{Gasto total en marketing y ventas}}{\text{Nº clientes nuevos}}$ \\
      \hline
      Onboarding (0--90 días) & Cliente en implementación inicial. &
      \% activación, tiempo de implementación, churn temprano. &
      Activación = $\tfrac{\text{Nº clientes que completan onboarding}}{\text{Nº clientes nuevos}} \times 100$ \newline
      Churn temprano = $\tfrac{\text{Nº clientes que abandonan \textless{}90 días}}{\text{Nº clientes nuevos}} \times 100$ \\
      \hline
      Cliente activo & Cliente que usa regularmente el sistema. &
      Engagement, NPS, CSAT, Nº tickets soporte. &
      NPS = (\% Promotores -- \% Detractores) \newline
      CSAT = Promedio encuestas (1--5) \newline
      Engagement = $\tfrac{\text{Nº sesiones o agendas usadas}}{\text{cliente}}$ \\
      \hline
      Cliente en riesgo & Bajo uso, falta de pago o quejas. &
      \% clientes en riesgo, tasa de rescate, churn predicho. &
      \% en riesgo = $\tfrac{\text{Nº clientes en riesgo}}{\text{Nº clientes activos}} \times 100$ \newline
      Rescate = $\tfrac{\text{Nº recuperados}}{\text{Nº en riesgo}} \times 100$ \\
      \hline
      Cliente retenido & Cliente que renueva. &
      Tasa de retención, renovación. &
      Retención = $\tfrac{\text{Nº clientes mantenidos}}{\text{Nº clientes inicio}} \times 100$ \newline
      Renovación = $\tfrac{\text{Nº renovaciones}}{\text{Nº clientes que debían renovar}} \times 100$ \\
      \hline
      Cliente en expansión & Cliente que aumenta uso (agendas, módulos, sedes). &
      Ingresos por upsell/cross-sell, NDR. &
      Upsell ingresos = $\sum \text{ventas adicionales}$ \newline
      NDR = $\tfrac{\text{Ingresos retenidos + expansión - churn}}{\text{Ingresos iniciales}} \times 100$ \\
      \hline
      Cliente churn & Cliente que abandona y no renueva. &
      Tasa de churn, pérdida de ingresos. &
      Churn rate = $\tfrac{\text{Nº clientes perdidos}}{\text{Nº clientes inicio}} \times 100$ \newline
      MRR churn = $\tfrac{\text{Ingresos perdidos}}{\text{Ingresos MRR inicial}} \times 100$ \\
      \hline
    \end{tabular}
  \end{threeparttable}
...
\clearpage
\section{Describe su rol}

\clearpage
\section{Justifica el proyecto}

\clearpage
\section{Define sus objetivos y alcances}
